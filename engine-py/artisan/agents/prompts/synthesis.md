  ...
  "recommendations": [
    {
      ...
      "headline": string (about 15 words; a clear one-line verdict),
      "sentiment_note": string (about 20 words),
      "technical_note": string (about 20 words),
      "fundamental_note": string (about 20 words),
      "thesis": string,
