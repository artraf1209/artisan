...
class FmpFundamentalsAdapter:
    ...
    def build_fundamental_row(self, symbol: str) -> tuple[dict, dict]:
        ...
        row = {
            ...
            "period_type": "annual",
            "pe_ratio": key_metrics.get("peRatio") or ratios.get("priceEarningsRatio"),
            "pb_ratio": key_metrics.get("pbRatio") or ratios.get("priceToBookRatio"),
            "roe": ratios.get("returnOnEquity") or key_metrics.get("roe"),
            "debt_equity": ratios.get("debtEquityRatio") or key_metrics.get("debtToEquity"),
